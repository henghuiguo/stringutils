# stringutils
This project provides a collection of **cross-platform** string operating utilities.


# How to use
1. Copy stringutils.h and stringutils.cpp to your project.
2. #include "stringutils.h"
3. Invoke APIs in namespace **cx**, as follows:
```cplusplus
   // Trim a string.
   cx::trim(str);
   // Determines whether two string have the save value.
   cx::equals("abc", "abc")
   // ...
```
